    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('userProfile.performance.salesPerformanceDesc')}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-border-primary bg-bg-tertiary p-4">
              <p className="text-sm text-text-secondary">{t('userProfile.performance.totalSales')}</p>
              <p className="text-2xl font-bold text-text-primary">₹4,50,000</p>
              <p className="text-xs text-status-success">+15% {t('userProfile.performance.vsTarget')}</p>
            </div>

            <div className="rounded-lg border border-border-primary bg-bg-tertiary p-4">
              <p className="text-sm text-text-secondary">{t('userProfile.performance.commissionsEarned')}</p>
              <p className="text-2xl font-bold text-text-primary">₹11,250</p>
              <p className="text-xs text-text-tertiary">{t('userProfile.performance.thisMonth')}</p>
            </div>

            <div className="rounded-lg border border-border-primary bg-bg-tertiary p-4">
              <p className="text-sm text-text-secondary">{t('userProfile.performance.dealsCompleted')}</p>
              <p className="text-2xl font-bold text-text-primary">45</p>
              <p className="text-xs text-status-success">+8 {t('userProfile.performance.vsLastMonth')}</p>
            </div>

            <div className="rounded-lg border border-border-primary bg-bg-tertiary p-4">
              <p className="text-sm text-text-secondary">{t('userProfile.performance.avgDealSize')}</p>
              <p className="text-2xl font-bold text-text-primary">₹10,000</p>
              <p className="text-xs text-text-tertiary">{t('userProfile.performance.perTransaction')}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('userProfile.performance.achievementsDesc')}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="flex items-center gap-3 rounded-lg border border-border-primary bg-bg-tertiary p-3">
            ...
            <div>
              <p className="font-medium text-text-primary">{t('userProfile.performance.topPerformer')}</p>
              <p className="text-xs text-text-tertiary">{t('userProfile.performance.topPerformerDesc')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 rounded-lg border border-border-primary bg-bg-tertiary p-3">
            ...
            <div>
              <p className="font-medium text-text-primary">{t('userProfile.performance.targetAchieved')}</p>
              <p className="text-xs text-text-tertiary">{t('userProfile.performance.targetAchievedDesc')}</p>
            </div>
          </div>
        </CardContent>
      </Card>
