...
const variantStyles: Record<TabsVariant, {
  ...
  default: {
    ...
    trigger: 'rounded-md data-[state=active]:bg-bg-secondary data-[state=active]:shadow-sm',
    triggerActive: 'text-text-primary',
  },
  pills: {
    list: 'gap-2',
    trigger: 'rounded-full border border-border-primary data-[state=active]:bg-accent data-[state=active]:border-accent data-[state=active]:text-white',
    triggerActive: 'text-text-primary',
  },
  underline: {
    list: 'border-b border-border-secondary gap-0',
    trigger: 'rounded-none border-b-2 border-transparent data-[state=active]:border-accent',
