...
const getAllPermissionKeys = (): (keyof ShopPermissions)[] => {
  return [
    ...
    'canGetPurchasePayments',
    'canGetBySupplier',
    'canViewPurchaseAnalytics',
    'canViewPendingPurchases',
    'canViewUnpaidPurchases',
    'canBulkDeletePurchases',
    'canBulkApprovePurchases',
    'canUploadPurchaseDocuments',
    ...
    'canCompletePayment',
    'canCancelPayment',
    'canViewPendingCheques',
    'canClearCheque',
    'canBounceCheque',
    'canViewBouncedCheques',
    'canViewClearedCheques',
    'canReconcilePayment',
    'canViewPendingReconciliation',
    'canViewReconciliationSummary',
    'canGenerateReceipt',
    'canSendReceipt',
    'canGetByParty',
    'canGetByReference',
    'canViewPaymentByMode',
    'canViewCashCollection',
    'canViewDigitalCollection',
    'canViewPaymentAnalytics',
    'canViewPaymentDashboard',
    'canViewTodaysPayments',
    'canViewPendingPayments',
    'canViewFailedPayments',
    'canApprovePayment',
    'canRejectPayment',
    'canProcessRefund',
    'canGetRefunds',
    'canBulkReconcile',
    'canBulkExportPayments',
    'canBulkPrintReceipts',
    'canViewPayments',
    'canReceivePayments',
    'canMakePayments',
    ...
    'canResumeOrder',
    'canMarkAsReady',
    'canMarkOrderAsDelivered',
    'canCompleteOrder',
    'canAssignOrder',
    'canReassignOrder',
    'canGetAssignedOrders',
    ...
    'canAddFeedback',
    'canGetFeedback',
    'canViewOverdueOrders',
    'canViewDueSoonOrders',
    'canViewPendingOrders',
    'canViewCompletedOrders',
    'canViewOrdersByType',
    'canViewOrdersByPriority',
    'canViewOrderAnalytics',
    'canViewOrderDashboard',
  ...
  reducers: {
    ...
    setCurrentShopPermissions: (state, action: PayloadAction<string>) => {
      ...
      if (shopAccess) {
        ...
        if (import.meta.env.DEV) {
          console.log(
            ` [permissionsSlice] Switched shop permissions: ${shopId}`
          )
        }
      } else {
        console.warn(
