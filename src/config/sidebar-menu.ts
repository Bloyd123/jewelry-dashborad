...
export const getMenuItems = (t: (key: string) => string): MenuItem[] => [
  ...
  },
  {
    ...
    icon: Users,
    items: [
      { title: t('sidebar.addCustomer'), url: ROUTES.addCustomer, icon: UserPlus },
      { title: t('sidebar.Allcustomer'), url: ROUTES.Allcustomer, icon: UserCheck  },
      { title: t('sidebar.customerdetail'), url: ROUTES.customerdetail, icon: Info  },
    ],
  },
  {
    ...
    icon: Truck,
    items: [
      { title: t('sidebar.supplierdetails'), url: ROUTES.supplierdetails,icon: Info },
      { title: t('sidebar.addSupplier'), url: ROUTES.addSupplier,icon: UserPlus },
      { title: t('sidebar.supplierlist'), url: ROUTES.supplierlist, icon: ClipboardList },
    ],
  },
  {
    ...
    icon: Building2,
    items: [
      { title: t('sidebar.shopList'), url: ROUTES.shopList, icon: ClipboardList },
  ...
  },
  {
    ...
    items: [
      ...
      { title: t('sidebar.addProduct'), url: ROUTES.addProduct, icon: PackagePlus  },
      { title: t('sidebar.productdetail'), url: ROUTES.productdetail, icon: Info  },
    ],
  },
  {
    ...
    icon: ShoppingCart,
    items: [
      { title: t('sidebar.allPurchases'), url: ROUTES.purchases, icon: ListOrdered },
      { title: t('sidebar.addPurchase'), url: ROUTES.addPurchase, icon: ShoppingBag },
  ...
  },
  {
    ...
    items: [
      ...
      { title: t('sidebar.detailsales'), url: ROUTES.detailsales, icon: FileText },
  ...
  },
  {
    ...
    icon: CreditCard,
    items: [
      { title: t('sidebar.addPayment'), url: ROUTES.addpayments, icon: CreditCard },
      { title: t('sidebar.allpayments'), url: ROUTES.allpayments, icon: Wallet },
    ],
  },
